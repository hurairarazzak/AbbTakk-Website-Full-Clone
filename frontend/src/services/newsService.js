...
const API_URL = 'https://abb-takk-website-full-clone-e4bu.vercel.app/api/news'; // adjust if needed

export const loginAdmin = async (email, password) => {
  const res = await axios.post('https://abb-takk-website-full-clone-e4bu.vercel.app/api/admin/login', {
    email,
    password,
  });
  return res.data;
